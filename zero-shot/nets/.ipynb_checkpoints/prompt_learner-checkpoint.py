...
def generate_category_list(dataset_name):
    if dataset_name == "vggsound":
        file_path = '/root/autodl-tmp/data/vggsound/VggsoundAVEL40kCategories.txt'
    elif dataset_name == "AVE":
        file_path = '/root/autodl-tmp/data/AVE/categories.txt'
    elif dataset_name == "AVQA":
        file_path = '/root/autodl-tmp/data/AVQA/ans_vocab.txt'
    elif dataset_name == "LLP":
         file_path = '/root/autodl-tmp/data/AVVP/catagory.txt'
    else:
