...
class BaseOptions():
	...
	def initialize(self):
		...
		### for AV-ada ###
		self.parser.add_argument('--audio_folder', type=str, default="/AVE_Dataset/raw_audio", help="raw audio path")
		self.parser.add_argument('--video_folder', type=str, default="data/AVE/frames", help="video frame path")
