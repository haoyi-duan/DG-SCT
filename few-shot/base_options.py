...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument("--weak", type=int, default=0, help="weakly supervised training")
		self.parser.add_argument("--classification", type=int, default=0)
		self.parser.add_argument("--shot", type=int, default=16, help="few-shot learning")        
		...
		self.parser.add_argument("--dataset_name", type=str, default="AVE", help="name of the dataset")
